...
<div class="col-md-12">
    <div class="container-index" style="color: black">
        ...
        <form method="POST" enctype="multipart/form-data" action="https://www.timpos.ru/admin/events">
            ...
            <div class="input-group row" style="min-width: 500px; justify-content: space-between">
            ...
            <br>
            <div class="input-group row" style="min-width: 500px; justify-content: space-between">
                <label for="name" class="col-sm-2 col-form-label">Номер: </label>
                <div class="col-sm-6" style="min-width: 350px">
                    <input type="text" class="form-control" name="name" id="name" value="">
                </div>
            </div>
            <br>
            <div class="input-group row" style="min-width: 500px; justify-content: space-between">
                <label for="name" class="col-sm-2 col-form-label">Почта: </label>
                <div class="col-sm-6" style="min-width: 350px">
                    <input type="text" class="form-control" name="name" id="name" value="">
                </div>
            </div>
