...
<div class="col-md-12">
    <div class="container-index" style="color: black">
        <div>
            <h1 style="color: black">Добавить кейс</h1>
        </div>
        <form method="POST" enctype="multipart/form-data" action="https://www.timpos.ru/admin/events">
            ...
            <br>
            <div class="input-group row">
                <label for="description" class="col-sm-2 col-form-label">Проблема: </label>
                <div class="col-sm-6">
            ...
            <br>
            <div class="input-group row">
                <label for="description" class="col-sm-2 col-form-label">Цель: </label>
                <div class="col-sm-6">
                    <textarea name="description" id="description" cols="72" rows="7"></textarea>
                </div>
            </div>
            <br>
            <div class="input-group row">
                <label for="description" class="col-sm-2 col-form-label">Результат: </label>
                <div class="col-sm-6">
                    <textarea name="description" id="description" cols="72" rows="7"></textarea>
                </div>
            </div>
            ...
            <div class="input-group row">
                ...
                <div class="col-sm-10" style="text-align: left">
                    <label class="btn btn-default btn-file">Загрузить <input type="file" style="display: none;" name="image" id="image">
                    </label>
                </div>
            </div>
            <br>
